...
export class DynConfigItemNamePipe implements PipeTransform {
    ...
    private static ITEM_NAMES: { [k: string]: string } = {
        ...
        'domain.defaults.markdown.images.enabled':     $localize`Enable images in comments`,
        'domain.defaults.markdown.links.enabled':      $localize`Enable links in comments`,
        'domain.defaults.markdown.tables.enabled':     $localize`Enable tables in comments`,
