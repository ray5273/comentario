...
export const USERS = {
    ...
    commenterThree: new User({isAnonymous: false, isSuper: false, id: 'a7ab1d55-cfaa-4f26-a1a6-88cc4c6ce96d', email: 'three@blog.com',              name: 'Commenter Three', password: 'user'}),
